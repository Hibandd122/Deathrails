...
-- Vòng lặp PromptsFar (chậm lại 3 giây)
...
task.spawn(fullBrightLoop)  -- Bật FullBright

print("Script đã chạy: Noclip, AutoWin, PromptsFar, FullBright đã được bật!")
