...
-- Hàm tấn công NPC liên tục (đã bỏ đường dẫn cụ thể)
local function attackNPCLoop()
    while isRunning and attackEnabled do
        ...
        -- Tìm tất cả các đối tượng trong Workspace có phần "Head" (giả định là NPC)
        local potentialTargets = Workspace:GetDescendants()
        local npcs = {}
